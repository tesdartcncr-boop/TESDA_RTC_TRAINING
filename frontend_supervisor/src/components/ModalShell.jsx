...
export default function ModalShell({ title, onClose, children, maxWidth = 'max-w-3xl' }) {
  ...
  return createPortal(
    <div className="fixed left-0 top-0 z-[1000] flex h-[100dvh] w-screen items-center justify-center overflow-y-auto bg-slate-950/70 p-4 backdrop-blur-sm sm:p-6">
