...
export default function TeachingLoads() {
  ...
  }, [teachingLoads, allTeachingLoads, selectedLoad, selectedProgram, selectedTrainer, refreshTeachingLoadCaches, loadProgramTeachingLoads, loadTrainerTeachingLoads, loadAllTeachingLoads])
              ...
              <div key={`week-${weekIndex}`} className="grid grid-cols-7 gap-1">
                {week.map((cell) => {
                  ...
                  return (
                    <div
                      key={cell.dateStr}
                      className={`aspect-square bg-white border rounded-lg p-2 text-center flex flex-col justify-between ${
                        isCustom 
