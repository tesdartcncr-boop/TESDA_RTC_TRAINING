...
const supervisorNavigation = [
  ...
  { name: 'Schedules', href: '/schedules', icon: Settings },
  { name: 'Supervisor Accounts', href: '/admin-accounts?role=supervisor', icon: ShieldCheck },
  { name: 'Statistics', href: '/statistics', icon: BarChart3 },
]
...
export default function Layout() {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-slate-950 text-slate-100 lg:gap-0">
      ...
      <div className="relative z-10 flex min-w-0 flex-1 flex-col lg:max-h-screen">
        ...
        <main className="flex-1 overflow-y-auto bg-gradient-to-br from-slate-100 via-sky-50 to-cyan-100/70 px-3 py-4 sm:px-4 sm:py-6 lg:px-6 lg:py-8 xl:px-10">
