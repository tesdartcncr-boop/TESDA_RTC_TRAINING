...
function useProgramSearch() {
  ...
  let selectedLabel = 'Search and select programs'
  if (selectedPrograms.length > 0) {
    selectedLabel = `${selectedPrograms.length} program${selectedPrograms.length === 1 ? '' : 's'} selected`
  }
    ...
    <div ref={containerRef} className="relative">
      ...
      >
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-gray-700">Assigned Programs</p>
